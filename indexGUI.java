...
class eventhai extends Frame implements ActionListener,KeyListener{
    ...
    eventhai(){
        ...
        nameText=new Label("    Name of Supplier               ");
        nametf=new TextField(8);
        ...
        foodname=new Label("Enter food item          ");
        ...
        billbtn =new Button("generate report");
    ...
    public void actionPerformed(ActionEvent ae)  {
        ...
        if(ae.getSource()==billbtn){
            ...
            frame2.setTitle("Generated Report");
            ...
            Label billhotel=new Label("               ");
            billhotel.setBounds(20,50, 250,40);

            Label billname=new Label("  "+nametf.getText());
            billname.setBounds(30,80, 400,40);

            Label line=new Label("---------------------------Inventory Report-------------------------------");
            line.setBounds(0,130, 1000,20);

            Label totalis =new Label("Total :");
            totalis.setBounds(160,360,70,20);

            Label line1=new Label("----------------------TOTAL COST-------------------------------");
